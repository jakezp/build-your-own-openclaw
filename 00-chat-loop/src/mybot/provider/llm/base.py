"""Responses-API-backed LLM provider for step 00 (chat-only, no tools)."""
...
class LLMProvider:
    """Responses-API client for the ChatGPT subscription backend (step 00)."""
    ...
    async def chat(
        ...
        **kwargs: Any,
        ...
        """Send a chat turn to the Responses API and return the final text."""
